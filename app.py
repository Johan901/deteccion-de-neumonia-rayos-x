...
def predict():
    ...
    if file:
        # Procesar la imagen
        img_path = 'static/uploaded_image.jpg'  # Guardamos la imagen en la carpeta 'static' para mostrarla
        file.save(img_path)  # Guardar la imagen temporalmente
        
        # Preprocesar la imagen
        img = image.load_img(img_path, target_size=(224, 224))  # Ajustar al tamaño de tu modelo
